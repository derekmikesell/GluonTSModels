...
class BasisLightningModule(pl.LightningModule):
    """
    A ``pl.LightningModule`` class that can be used to train a ``BasisModel``
    with PyTorch Lightning.

    This is a thin layer around a (wrapped) ``BasisModel`` object,
    ...
    def __init__(
        ...
        self.model = BasisModel(**model_kwargs)
        self.lr = lr
